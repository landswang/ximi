...
/**
 * 
 * 项目名称：--- 模块名称：接入层 功能描述：权限类型枚举 创建人： torreswang 创建时间：2017年5月8日 上午11:43:12 修改人： torreswang
...
public enum AuthCode {
  ...
  public String toString() {
    return String.format("authId:%s, authCode:%s, authName:%s, authDesc:%s", this.authId,
        this.authCode, this.authName, this.authDesc);
  }
