...
public class LoanInfoServiceImpl implements LoanInfoService {
  ...
  public boolean alterLoanValue(SearchCondition sc) {
    ...
    if (nbAll != 0) {
      appMoney = nl.getAppMoney().floatValue();// 初审贷款金额
      nbCRate = appMoney / nbAll;// 我行抵押率
      ...
      gv.setNbComfirmValue(new BigDecimal(0));
      gv.setNbCRate(0);
    }
