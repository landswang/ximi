...
public class FilePathView {
  ...
  public String toString() {
    return "FilePathView [serviceType=" + serviceType + ", docType=" + docType + ", doc=" + doc
        + ", loanId=" + loanId + ", name=" + name + ", sourceFlag=" + sourceFlag + ", filename="
        + filename + ", docArr=" + Arrays.toString(docArr) + ", initName=" + initName
        + ", fileType=" + fileType + "]";
  }
